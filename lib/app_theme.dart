...
class AppTheme {
  ...
  static const Color surfaceColor = Color(0xFF1B2531); // for text fields, cards, etc.
  ...
  static const TextStyle bodyStyle = TextStyle(color: textColor);
  ...
  static final CupertinoThemeData cupertinoTheme = CupertinoThemeData(
    ...
    textTheme: CupertinoTextThemeData(
      ...
      navLargeTitleTextStyle: titleStyle.copyWith(fontSize: 34, color: textColor),
